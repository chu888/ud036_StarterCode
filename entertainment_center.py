...
"""  The import "fresh_tomatoes.py" help generate a website that displays these movies, it provides a
starter code repository that contains a Python module.
"""
import media
"""
...
psycho = media.Movie("Psycho", "A Phoenix secretary embezzles $40,000, goes on the run, and checks"
...
Requiem_for_a_Dream = media.Movie("Requiem for a Dream", "The drug-induced utopias of four Coney Island people"
